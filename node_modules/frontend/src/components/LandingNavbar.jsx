    ...
    return (
        <nav className={`quick-nav${revealed ? ' nav-revealed' : ''}${scrolled ? ' nav-scrolled' : ''}`}>
            <div className="quick-nav__inner">
                {/* Logo */}
                <Link to="/" className="quick-nav__logo">
                ...
                <div className="quick-nav__cta desktop-menu" style={{ display: 'flex', gap: '0.5rem' }}>
                    ...
                    <Link
                        ...
                        style={{ padding: '0.45rem 1.1rem', fontSize: '0.85rem', border: '1px solid #2563EB', color: '#2563EB', background: 'transparent', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                    >
                        Login
                    </Link>
                </div>
