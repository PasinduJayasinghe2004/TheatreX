...
const EmergencyBooking = () => {
    ...
    // Styling
    const inputClass = "w-full px-4 py-3 border border-gray-200 rounded-lg text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-500 transition-all";
    const labelClass = "block text-sm font-semibold text-gray-700 mb-1.5";
    const selectClass = "w-full px-4 py-3 border border-gray-200 rounded-lg text-gray-600 text-sm focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-500 transition-all appearance-none bg-white";
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="flex justify-center gap-4 pt-4 border-t">
                                <button
                                    ...
                                    onClick={() => navigate(-1)}
                                    disabled={loading}
                                    className="px-8 py-3 text-gray-600 font-medium rounded-lg hover:bg-gray-100 transition-colors disabled:opacity-50"
                                >
                                    Cancel
                                </button>
                                <button
